        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                       ...
                       <div class="mb-3">
                      <form action="/unit_search" method="GET" role="search">
                        <div class="row">
                            <div class="col-md-10">
                                <input name="unit" type="text" class="form-control" placeholder="search">
                            </div>
                            <div class="col-md-2">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered table-sm">
                            <thead>
                                <tr>
                                <th class="sorting" style="width: 70%; cursor: pointer;">Quantity Unit</th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div role="group" class="btn-group">
                                            <button data-id="{{ $units->id }}"  class="btn btn-link btn-sm btn_edit"><span class="fa fa-edit"></span></button>
                              
                                            <button data-id="{{ $units->id }}" class="btn btn-link text-danger btn-sm btn_delete"><span class="fa fa-trash"></span></button>
                                        </div>
                                    </td>   
                                </tr>
                            </tbody>
                        ...
                        {{ $unit->appends(request()->except('page'))->links() }}   
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                  <div class="form-group">
                        ...
                        <input type="text"placeholder="Unit Name" class="form-control name" autofocus>
                  </div>
